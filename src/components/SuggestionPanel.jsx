...
const SuggestionPannel = () => {
  ...
  let {login,dispatch,OpenSuggestionPanel,openReportIssuePanel,OpenFeedbackPanel,OpenContactPanel} = useContext(AppContext)
  ...
  let handleReportIssue = ()=>{
    ...
    //   },2000)
      ...
      dispatch({type:'CLOSEFEEDBACK'})
      dispatch({type:'OPENSUGGESTIONMESSAGE'})

      setTimeout(()=>{
        dispatch({type:'CLOSEUGGESTIONMESSAGE'})
  ...
  return (
    ...
    <>
      ...
      <div className="Suggestion mobileanimationclass reportPanel d-flex flex-column align-items-end justify-content-center loginreportpanel">
        <div className="cardd loginCard">
          <div className="headerr d-flex flex-column align-items-center justify-content-between">
            <p>
              Share your <span className="dark">Suggestion</span> with us 
          ...
          <div className="issue-Content loginissuepaddingy">
            ...
            <div className="description-section pt-5 logindescripnotoppadding">
              <div className="desc-label mb-3 ">
                <label htmlFor="input-wrapper custominwra xxx" style={{width:'19rem'}}>Describe the suggestion in detail<img src={asterix} alt="" className=" ms-1 d-inline"/></label>
              </div>
              <div className="deswc d-flex flex-column align-items-end mqlogindeswc">
                ...
                {/* <button className={` ${text === '' && selectedOption === 'Select'?'submitbtn':'submitbtndark'}`} onClick={handleReportIssue}>Submit</button> */}
                <button className={` loginsubmitbtn ${text !== '' && selectedOption !== 'Select' ? 'submitbtndark' : 'submitbtn disabled'}`} onClick={handleReportIssue}>Submit</button>
        ...
        <div className={`nav4-icon-box fabddd1 ${OpenContactPanel?'selectedclass':''}`}  onClick={()=>{
            console.log('hello');
        ...
        <div className={`fabddd2 d-flex justify-content-center align-items-center ${OpenSuggestionPanel?'selectedclass':''}`}   onClick={()=>{
            console.log('hello');
        ...
        <div className={`fabddd3 d-flex justify-content-center align-items-center  ${OpenFeedbackPanel?'selectedclass':''}`} onClick={()=>{
            console.log('hello');
        ...
        <div className={`fabddd4 d-flex justify-content-center align-items-center  ${openReportIssuePanel?'selectedclass':''}`} onClick={()=>{
            console.log('hello');
        ...
        <div className="fabddd5 d-flex justify-content-center align-items-center" onClick={() => {
            dispatch({ type: "CLOSEFEEDBACK" });
            dispatch({type:'CLOSECONTACTPANEL'})
            dispatch({type:'CLOSEREPORTISSUEPANEL'})
            dispatch({type:'CLOSEFEEDBACKPANEL'})
      ...
      <div className="Suggestion mobileanimationclass reportPanel d-flex flex-column align-items-end justify-content-center ">  
        <div className="cardd emailCard notloginsugestCard contactnotlogin">
          <div className="headerr d-flex flex-column align-items-center justify-content-between">
          <p>
              Share your <span className="dark">Suggestion</span> with us 
              for a chance to earn rewards!
          ...
          <div className="issue-Content notloginissue">
            <div className="choose-Section py-5 notloginchoosesectionsugestion">
              <label htmlFor="" className="chooseSectionLabel mb-3 notloginChooseSectionLabel">Choose a section</label>
              {/*dropdown*/}
              <div className="dropdown notloginChooseSectionDropDown" onClick={() => setIsOpen(!isOpen)}>
                <div className="dropdown-button d-flex align-items-center">
                  <p className="mb-0">{selectedOption}</p>
                  <img src={dopdownarrow} alt="" className="dopdownarrow"/>
                </div>
            ...
            <div className="description-section pt-5 email-description-section notLogindescSec">
              ...
              <div className="deswc d-flex flex-column align-items-end emaildeswc notloginalignstart">
                <div className="textfield d-flex flex-column justify-content-between notlogintextField">
                  <input type="text" className="input-wrapper" name="input-wrapper" placeholder="Write Here" value={text} onChange={(e)=>{settext(e.target.value)}}/>
                  <div className="attach-d notLoginSuggestionAttachd">
                    <div className="att-icon-box d-flex align-items-center px-2">
                      <img src={attachIcon} alt="" />
                      <p className="mb-0 ms-2">Attach</p>
                    </div>  
              ...
              <label htmlFor="email-label mb-2">Enter your email to receive an update</label>
               ...
               */}
               <button className={`notloginsubbtnnnn ${text.trim() !== '' && email.trim() !== '' && selectedOption.trim() !== 'Select' ? 'submitbtndark' : 'submitbtn disabled'}`} onClick={handleReportIssue}>Submit</button>
